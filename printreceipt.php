...
$sql="SELECT * from cart,item,v_cart where  item.item_id=cart.item_id AND v_cart.item_name=item.item_name";
...
<div class="container" action >
 <div class="row">
   <div class="column-33">
	...
	<a target="_blank" href="w_user.php?item_id=<?php echo $item_id; ?>">
