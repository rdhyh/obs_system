...
<!DOCTYPE html>
<html>
<title>SIGN UP:ONLINE BAKERY SHOP SYSTEM </title>
...
<body>
  ...
  <img src="Online Bakery Shop Logo.png" alt="Online Bakery Shop Logo" style="width:80%;max-width:300px">
        <h3><b>Sign Up:</b></h3>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p><b>Already have an account? <a href="loginbakery.php">Login here</a>.</b></p>
        </form>
    </div>    
</body>
</html>