...
<div id="content">
<div class="container">
<h4><strong><center>Category List</strong></center></h4>
<table class="table table-hover" border="0px" width="600" align="center" cellspacing="5" cellpadding="5">
  <thead>
<tr>
<td align="center" bgcolor="#e9637b"><strong>ID Category</strong></td>
<td align="center" bgcolor="#e9637b"><strong>Category Name</strong></td>
...
//echo "<td>" .$row["dob"]."</td>";
 ...
 echo "<td>","<a href=\"updatecategory.php?category_id=$category_id\">Edit</a>";
 echo "<td>","<a href=\"deletecategory.php?category_id=$category_id\">Delete</a>";
}
echo "</table>";
echo "<center>";
echo "<br>";
